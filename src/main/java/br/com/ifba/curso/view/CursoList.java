...
public class CursoList extends javax.swing.JFrame {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        // TODO add your handling code here:
         // Pega o JDialog criado pelo Spring (com controller injetado)
    CursoAdd telaAdicionar = context.getBean(CursoAdd.class);

    // Centraliza em relação à tela atual
    telaAdicionar.setLocationRelativeTo(this);
        // Mostra a tela de adicionar. 
        //    IMPORTANTE: Como ela é 'modal', o CÓDIGO AQUI PAUSA 
        //    e só continua quando a 'telaAdicionar' for fechada.
        telaAdicionar.setVisible(true);

        // PONTO-CHAVE: Este é o nosso "refresh"!
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        if (cursoParaEditar != null) {
            ...
            CursoEdit telaEditar = context.getBean(CursoEdit.class);
            
            // MUITO IMPORTANTE: enviar o curso selecionado
            telaEditar.setCurso(cursoParaEditar);
